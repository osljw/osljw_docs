...
人类有「世界模型」，语言只是接口，语言只是给已有世界模型贴标签

证据： 
1. 婴儿不会说话，但已经拥有完整的「世界模型」
2. 先天聋哑人，没有语言，人照样能思考、推理、做计划。“语言是思维的基础”（错误）

- 失语症： 有些人语言能力完全损坏，但：能认东西、懂动作、懂情绪、能推理、能生活。
- 失认症： 有些人世界模型损坏，但说话流利，语法完美，就是不懂世界。
