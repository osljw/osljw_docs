...
```
spark.yarn.archive=mdfs://cloudhdfs/newsclient/data/sumitli/package/python37.tar.gz#python37;spark.yarn.appMasterEnv.PYSPARK_PYTHON=./python37/bin/python;spark.executorEnv.PYSPARK_PYTHON=./python37/bin/python
```
...
# map and flatMap and mapPartitions
flatMap 会自动过滤空列表
```
